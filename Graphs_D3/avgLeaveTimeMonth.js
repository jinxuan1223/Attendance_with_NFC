...
//set the starting and ending value for y axis 
...
// get the data
d3.csv("avgLeaveTimeMonth.csv").then(function(data) {
    ...
    maxHour = d3.max(data, function(d){ return d.avg_time.getHours(); })
    end_of_day.setHours(maxHour+1, 0,0,0);

    // Scale the range of the data in the domains
    x.domain(data.map(function(d){ return d.month; }));
    y.domain([start_of_day,end_of_day]);
    ...
    svg.append("text")
        ...
        .text('Average Leaving Time Of Each Month')
        .style("fill", "white");
